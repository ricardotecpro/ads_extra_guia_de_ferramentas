...
3.  **Pirâmide de Testes**: Por que é um erro estratégico ter 1000 testes de interface (E2E) e apenas 10 testes unitários em um projeto? Relacione sua resposta com custo e velocidade.
4.  **Lógica TDD**: Descreva os 3 passos do ciclo "Red-Green-Refactor" e por que o passo "Refactor" é importante mesmo que o teste já tenha passado.
